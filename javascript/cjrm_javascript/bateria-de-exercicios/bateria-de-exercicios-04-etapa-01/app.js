/*
  ...
  - Armazene em uma constante "sentence" a frase abaixo, modificando "SÉRIE_01, SÉRIE_02 e SÉRIE_03" para as suas séries favoritas;
  - O "e" antes do nome da última série deve ser mantido;
  - Forme essa frase sem digitar o nome das séries (claro) e sem utilizar a notação "array[index]";
  - Exiba a frase no console.

  "Minhas 3 séries favoritas são: SÉRIE_01, SÉRIE_02 e SÉRIE_03."
*/

const my3FavoriteTVShows = ["Friends", "Dark", "Dexter"];
...
/*
  ...
  - Armazene a frase abaixo em uma constante "typeSentence", substituindo "TIPO_DE_DADO" pela informação correta;
...
/*
  ...
  - Exiba a frase abaixo no console, substituindo "NÚMERO_DE_CARACTERES" por 39 e "BOOLEAN" pela informação correta (true ou false);
...
// Resposta: Ao realizar uma operação matemática envolvendo null, ele é interpretado como zero. A soma de 0 + 1 é igual a 1. É o 1 quearmazenando na crazyConversion. 1 é um valor Truthy.
...
/*
  ...
  - Armazene em uma const "isNotAString" uma expressão que verifica se o tipo de dado que a "randomTVShow" armazena não é uma string;
...
/*
  ...
  - Abaixo da constante "evenNumbers", exiba no console um boolean que indica se o número 8 existe no array;
...
// OBS: Se passar por argumento para o indexOf um index que não existe no array, ele vai retornar -1. Então, para obter um boolen que indica se o número 8 existe no array, vamos comparar se o retorno dessa expressão é diferente de -1. 