...
/*
  ...
  - Abaixo do array "animals", verifique se o animal "leão" **não** existe no array. Se não existir, exiba no console a mensagem "Leão não existe no array animals.";
...
/*
  ...
  - Se durante a soma, o resultado ultrapassar 400, pare a operação e exiba a frase abaixo no console substituindo "RESULTADO_DA_SOMA" pelo valor correto.
...
for (let i = 0; i < randomNumbers.length; i++) {
  if (sumResult > limit) {
    console.log(
      `A soma ultrapassou ${limit}. Até aqui, o valor atual é ${sumResult}.`
    );
    break;
  }
