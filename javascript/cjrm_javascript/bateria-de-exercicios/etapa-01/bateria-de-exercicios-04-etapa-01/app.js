...
const my3FavoriteTVShows = ["Dark", "Friends", "The Chosen"];
const sentence =
  `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(", ")}.`.replace(
    ", T",
    " e T",
  );
...
const randomTVShow = "Watchmen"; // É o item que quero buscar dentro do array my3FavoriteTVShows, por isso, randomTVShow fica dentro do includes()
...
// OBS: Por baixo dos panos. o  ${falsyValues.length} e o ${falsyValues[2]} estão sendo convertidos para string.
...
/*
 RESPOSTA: 
-> Quando executamos alguma operação matemática envolvendo null, ele é interpretado como zero. 
-> 0 + 1 = 1 
->Então, o que estamos armazenando na crazyOperation é o 1. 
-> 1 é um valor Truthy, ou seja, quando 1 é convertido para Boolean -> Boolean(crazyOperation), o resultado é true. 
-> Por isso a crazyConversion armazenou true.
*/
...
// Parte 2 da aula 3 foi falado sobre o indexOf() e o que ele retorna. 
// Se passarmos como argumento do indexOf() um item que não exite no array, ele vai retornar -1. 
// Então, para obter um Boolean que indica se o número 8 existe no array, vamos comparar se o retorno da expressão evenNumbers.indexOf(8) que resulta em 4, é diferente de -1. 
// 4 é diferente de -1? Sim! 
// Então o console retorna true.