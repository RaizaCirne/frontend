...
const my3FavoriteTVShows = ["Dark", "Sense8", "Friends"];
...
// console.log(typeSentence.length);
// console.log("A string que a typeSentence armazena tem mais de " + 39 + " caracteres? " + String(true))
...
const crazyConversio = Boolean(crazyOperation);

// console.log(crazyConversio);
// Quando executamos alguma operação matemática envolvendo null, ele é interpretado/avaliado como zero, ou seja, 0 + 1 resulta em 1, então o que estamos armazenando é o valor 1. Sabemos que o valor 1 é um valor Trythy. Quando 1 é convertido para Boolean, o resultado é 1.
