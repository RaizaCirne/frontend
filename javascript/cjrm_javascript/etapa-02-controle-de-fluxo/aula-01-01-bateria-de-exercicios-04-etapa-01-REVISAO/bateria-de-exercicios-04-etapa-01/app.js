...
const sentence = `${my3FavoriteTVShows.slice(
  0,
  2
)} e ${my3FavoriteTVShows.slice(2)}`;
...
/*
  ...
  - Exiba no console um boolean indicando se o array de séries que você criou possui 3 itens.
*/
