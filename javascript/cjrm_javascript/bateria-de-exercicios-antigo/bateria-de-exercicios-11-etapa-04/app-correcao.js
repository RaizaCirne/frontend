...
// Resposta: O erro aconteceu porque a age tem um escopo local. Como a age foi declarada dentro da função logAge(), a não ser que dentro da função a gente retorne o valor dela, ela não vai ser acessada fora do bloco de código. A let só está disponível dentro do escopo da função logAge().
...
let car = {
  name: "Passat",
  brand: "Volkswagen",
  colors: ["Azul Atlantic", "Vermelho Crimson", "Preto Mystic"],
  isRunning: false,
  run() {
    this.isRunning = true;
