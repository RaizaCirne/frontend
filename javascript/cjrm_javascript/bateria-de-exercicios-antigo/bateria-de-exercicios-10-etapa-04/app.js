...
let suvs = ["Honda HR-V", "Jeep Renegade", "Ford EcoSport", "Hyundai iX35"];
...
console.log(myObjects("null"));
console.log(myObjects("undefined"));
console.log(myObjects("object"));
